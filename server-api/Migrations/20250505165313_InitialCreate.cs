        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tariffs_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProviderRatings_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProviderChoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserProviderChoices_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProviderChoices_Tariffs_TariffId",
                        column: x => x.TariffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderRatings_UserId",
                table: "ProviderRatings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Tariffs_ProviderId",
                table: "Tariffs",
                column: "ProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProviderChoices_ProviderId",
                table: "UserProviderChoices",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProviderChoices_TariffId",
                table: "UserProviderChoices",
                column: "TariffId");
